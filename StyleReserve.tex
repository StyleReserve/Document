...
\begin{figure}[htbp]
\centerline{\includegraphics[width=3cm]{ex_closet.png}}
\label{fig}
...
\subsection{My Page}
\begin{figure}[htbp]
\centerline{\includegraphics[width=3cm]{ex_mypage.png}}
\label{fig}
...
\begin{table} [h]
    \begin{tabular}{p{1.7cm}|p{3cm}|p{2.5cm}}
    \hline
...
\begin{itemize}
    \begin{figure}[htbp]
    \centerline{\includegraphics[width=5cm]{main_page_top_box.png}}
    \label{fig}
    ...
    \item Today’s status: This is a box spaces on the top that allows users to check recently planned reservations, composed with Styler and Styling reservation. It can’t be clicked, only for the viewing purpose.\\
     ...
     \begin{figure}[htbp]
    \centerline{\includegraphics[width=5cm]{styler_button.png}}
    \label{fig}
    ...
    \begin{figure}[htbp]
    \centerline{\includegraphics[width=5cm]{stylingr_button.png}}
    \label{fig}
